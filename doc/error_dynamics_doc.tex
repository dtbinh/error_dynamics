...
\mathbf{C} &= \hat{\Inertia}^{-1} \left( \sum_{i=1}^k -\epsilon_i \kmomh n_i^2 \mathbf{e}_z + n_i^2 \mathbf{e}_z \times \mathbf{r}_i \right) ,\\
\mathbf{D} &= \hat{\Inertia}^{-1} \left( \sum_{i=1}^k -\epsilon_i \kthrh n_i^2 \mathbf{e}_z  \right) ,\\
...
\end{bmatrix} - \ldots \\
&~ \mathrm{diag} \left( \hat{\Inertia}^{-2} \left( \sum_{i=1}^k \left( -\epsilon_i \kmomh \kthrh n_i^2 \mathbf{e}_z + \kthrh n_i^2 \mathbf{e}_z \times \mathbf{r} \right) - \skewsym{\hat{\angvel}} \hat{\Inertia} \hat{\angvel} \right) \right), \\
...
We get
\begin{align}
\mathbf{F}_k &= \mathbf{I} + \mathbf{F}_c \Delta t, \\
\mathbf{Q}_k &= \mathbf{G}_c \mathbf{Q}_c \mathbf{G}_c^T \Delta t ^2.
\end{align}
