...
The system matrix \ref{eq:system_discrete}, however, leads to some coupling which also affect covariance growth in position and attitude as well as parameter uncertainty. The parameter uncertainty grows in the correlated terms due to the coupling terms \mathbf{A}, \mathbf{C}, \mathbf{D}, \mathbf{E} from equations \ref{eq:A}, \ref{eq:C}, \ref{eq:D}, \ref{eq:E}. 
